...
export default function VolunteerSidebar() {
  ...
  const links = [
    ...
    { href: "/volunteer/tasks", label: "Available Tasks", icon: "✓" },
    { href: "/volunteer/my-tasks", label: "My Tasks", icon: "📋" },
    { href: "/volunteer/profile", label: "Profile", icon: "⚙️" },
  ]
    ...
    <>
      ...
      >
        <div className="p-6 border-b border-border">
          <Link href="/volunteer/dashboard" className="flex items-center gap-2 font-bold text-lg">
